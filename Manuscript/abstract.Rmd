Field boundaries can improve crop yields by creating better abiotic conditions for crop growth (e.g. mosture, temperature), and can act as refuges for beneficial arthropods.
...
Average crop yield tended to increase with distance from crop boundaries before plateauing at about 50 m, and yield variation (SD) tended to decrease concurrently with distance.
Differences between boundary types tended to be weak and variable, especially for wheat; there was some evidence of certain field boundaries causing a greater decrease in yield at the edge, but these differences tended to be small in magnitude (<5% of yield).
Furthermore, there was little evidence of an intermediate increase in yield, suggesting that a) ecosystem services do not strongly depend on distance or b) their effect is relatively small.
