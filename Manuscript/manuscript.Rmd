...
Because of this, studies of SNL effects on crop yield tend to suffer from limited spatial scope and small sample sizes, reducing statistical power and generality [@brandle1984; @baker2018; but see also @redhead2020].
Meta-analyses are a common solution to this problem [e.g. @albrecht2020; @lowe2021], but precision yield data holds enormous promise because of its relatively common usage and low operating costs [@osorio2018]. 
...
Divvstances from boundary types were also important, but a lower proportion of the fields had strong effects (rows 1-5, cols 3 + 5). 
...
While we found an intermediate positive effect of shelterbelts on wheat, other studies have shown variable impacts of shelterbelts, ranging from no effect [@akbar1990; @crawford1998] to a positive effect [@staple1955; @kowalchuk1995; @bao2012]. 
This is complicated by the fact that their impact also depends on year-to-year water stress, shelterbelt orientation, as well as the physical structure of the shelterbelt [@pelton1967; @kort1988; @singh1999].
However, @kowalchuk1995 found that positive effects of shelterbelts on wheat yield occur at around 20 m, while our work shows a peak at around 50 m, and were tied to increased snow deposition and reduced water stress.
This also may be related to soil deposition from shelterbelts [@deJong1995]
Strangely, we also found this intermediate yield maximum with distance away from bare (flooded or fallow) field boundaries, indicating that the patterns we found may be at least somewhat related to water stress.
Shelterbelts can harbour predators or parasitoids of wheat crops [@dong2015; @ward2021]
