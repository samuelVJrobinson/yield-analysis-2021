...
- Summary:
  - At the level of individual fields, there was substantial variation in yield with distance from the field boundary, as well as with harvest sequence and spatially within each field
  - Overall, however, the effect of field boundary on yield was inconsistent and the change in mean yield tended to be small ($\sim$0.5 T/ha for canola)
