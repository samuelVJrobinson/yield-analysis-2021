...
- Field boundaries were automatically digitized, then manually checked using satellite imagery from Google Earth and classified land cover data from AAFC 
  ...
  - Because of this, we define the following general categories for field boundaries:
    ...
    5. Bare: unplanted, fallow, flooded area, temporary wetland, staging yard, oil and gas equipment, or road with no planted boundary
