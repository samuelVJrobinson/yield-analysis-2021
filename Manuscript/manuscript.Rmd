...
At the field level, both yield average and yield variability (SD of yield) of yield were extremely spatially (average p-values: `r canolaMods$meanP[canolaMods$Smoother=='s(E,N)']`, `r canolaMods$meanP[canolaMods$Smoother=='s.1(E,N)']`) and temporally dependent (`r canolaMods$meanP[canolaMods$Smoother=='s(r)']`, `r canolaMods$meanP[canolaMods$Smoother=='s.1(r)']`), meaning that average and variablity changed with location in the field, as well as sequentially during the harvest.
