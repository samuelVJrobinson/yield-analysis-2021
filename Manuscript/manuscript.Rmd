...
- Field boundaries were automatically digitized, then manually checked using satellite imagery and classified land cover data 
  ...
  - Because of this, we define the following general categories for field boundaries:
    ...
    3. Shelterbelt: permanent windbreaks, shelterbelts, or remnant forests and shrublands
    4. Other crop: annual crop or pasture with little or no visible boundary between planted areas 
    5. Bare: unplanted (fallow), flooded area, staging yard or road with no planted boundary
    6. Grassland: permanent seminatural grassland
