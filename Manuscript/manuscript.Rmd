...
<!-- - The variables that moderate spillover and yield needs to be re-investigated -->
...
Field boundaries may affect crop yield at intermediate distances, depending on the spatial scale at which ecosystem services operate, as they can induce positive and negative effects on crops.
Field boundaries can cause low yields at the edge of crops because of patchy seed emergence, poor microclimate, shading, and greater competition with weeds.
At the same time field boundaries can provide helpful ecosystem services, such as pest suppression or pollination, but these tend to be concentrated around the field edge.
...
Therefore, yield may be maximized at intermediate distances, where the ecosystem services cancel out negative edge effects [@mitchell2014; @vanVooren2017; Figure \@ref(fig:hypotheses)].
...
Ecosystem services from field boundaries can influence both the mean and variability of yield in agroecosystems [@redhead2020]; typically only averages (means) are considered, but higher stability (lower variance) in yield can also be valuable from a grower's perspective.
...
Our work examined only the first and last links in the causal chain _Field boundary_ $\rightarrow$ _Insect Abundance_ $\rightarrow$ _Crop Yield_, but there are two places where this chain could be broken.
First, field boundaries may not have any influence on insect abundance if separated from the larger landscape context.
Second, beneficial insect abundance may not influence crop yield if pest pressure or pollination deficits are low.
